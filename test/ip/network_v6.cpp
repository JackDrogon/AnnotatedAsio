...
void test()
{
	...
	try {
		...
		ip::network_v6 net1(ip::make_address_v6("2001:370::10:7344"),
				    64);
		ip::network_v6 net2(ip::make_address_v6("2001:370::10:7345"),
				    96);
...
void test()
{
	...
	// prefix length
	BOOST_ASIO_CHECK(
	    make_network_v6("2001:370::10:7344/128").prefix_length() == 128);
	BOOST_ASIO_CHECK(network_v6(make_address_v6("2001:370::10:7344"), 27)
			     .prefix_length() == 27);
	...
	BOOST_ASIO_CHECK(
	    std::distance(net13.hosts().begin(), net13.hosts().end()) == 2);
	BOOST_ASIO_CHECK(
	    std::distance(net14.hosts().begin(), net14.hosts().end()) == 8);
	BOOST_ASIO_CHECK(
	    std::distance(net15.hosts().begin(), net15.hosts().end()) == 512);
	BOOST_ASIO_CHECK(*net12.hosts().begin() ==
			 make_address_v6("2001:0370::"));
	BOOST_ASIO_CHECK(net12.hosts().end() !=
			 net12.hosts().find(make_address_v6(
			     "2001:0370::ffff:ffff:ffff:ffff")));
	BOOST_ASIO_CHECK(*net13.hosts().begin() ==
			 make_address_v6("2001:0db8::"));
	BOOST_ASIO_CHECK(net13.hosts().end() !=
			 net13.hosts().find(make_address_v6("2001:0db8::1")));
	BOOST_ASIO_CHECK(net13.hosts().end() ==
			 net13.hosts().find(make_address_v6("2001:0db8::2")));
	BOOST_ASIO_CHECK(*net14.hosts().begin() ==
			 make_address_v6("2001:0db8::"));
	BOOST_ASIO_CHECK(net14.hosts().end() !=
			 net14.hosts().find(make_address_v6("2001:0db8::7")));
	BOOST_ASIO_CHECK(net14.hosts().end() ==
			 net14.hosts().find(make_address_v6("2001:0db8::8")));
	BOOST_ASIO_CHECK(*net15.hosts().begin() ==
			 make_address_v6("2001:0db8::"));
	BOOST_ASIO_CHECK(
	    net15.hosts().end() !=

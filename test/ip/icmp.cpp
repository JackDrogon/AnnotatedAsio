...
void test()
{
	...
	try {
		...
		ip::icmp::socket socket4(ioc,
					 ip::icmp::endpoint(ip::icmp::v4(), 0));
		ip::icmp::socket socket5(ioc,
		...
		ip::icmp::socket::lowest_layer_type &lowest_layer =
		...
		(void)i5;
		int i6 = socket1.async_send(buffer(mutable_char_buffer),
					    in_flags, lazy);
		(void)i6;
		int i7 = socket1.async_send(buffer(const_char_buffer), in_flags,
					    lazy);
		(void)i7;
		...
		(void)d5;
		double d6 = socket1.async_send(buffer(mutable_char_buffer),
					       in_flags, dlazy);
		(void)d6;
		double d7 = socket1.async_send(buffer(const_char_buffer),
					       in_flags, dlazy);
		(void)d7;
		...
		int i14 = socket1.async_send_to(
		    null_buffers(), ip::icmp::endpoint(ip::icmp::v6(), 0),
		    lazy);
		(void)i14;
		...
		(void)i20;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d9 = socket1.async_send_to(
		    buffer(mutable_char_buffer),
		    ip::icmp::endpoint(ip::icmp::v4(), 0), dlazy);
		(void)d9;
...
void test()
{
	...
	try {
		...
		ip::icmp::resolver::results_type results2 =
		...
		ip::icmp::resolver::results_type results9 = resolver.resolve(
		    ip::icmp::v4(), "", "", ip::icmp::resolver::flags());
		(void)results9;
		...
		ip::icmp::resolver::results_type results11 =
		    resolver.resolve(e);
		(void)results11;

		ip::icmp::resolver::results_type results12 =
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d4 =
		    resolver.async_resolve(ip::icmp::v4(), "", "", dlazy);
		(void)d4;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)

		resolver.async_resolve(ip::icmp::v4(), "", "",
				       ip::icmp::resolver::flags(),
				       resolve_handler());
		int i5 = resolver.async_resolve(
		    ip::icmp::v4(), "", "", ip::icmp::resolver::flags(), lazy);
		(void)i5;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d5 = resolver.async_resolve(
		    ip::icmp::v4(), "", "", ip::icmp::resolver::flags(), dlazy);
		(void)d5;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)

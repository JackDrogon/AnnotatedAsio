...
void test()
{
	...
	try {
		...
		ip::address_v4 addr1;
		const ip::address_v4::bytes_type const_bytes_value = {
		    {127, 0, 0, 1}};
...
void test()
{
	...
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0x01000000)) ==
			 class_a_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0x7F000000)) ==
			 class_a_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0x80000000)) ==
			 class_b_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xBFFF0000)) ==
			 class_b_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xC0000000)) ==
			 class_c_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xDFFFFF00)) ==
			 class_c_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xE0000000)) ==
			 other_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xEFFFFFFF)) ==
			 other_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xF0000000)) ==
			 other_net);
	BOOST_ASIO_CHECK(address_v4::netmask(address_v4(0xFFFFFFFF)) ==
			 other_net);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
}

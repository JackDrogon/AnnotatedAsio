...
void test()
{
	...
	try {
		...
		archetypes::settable_socket_option<void>
		    settable_socket_option1;
		archetypes::settable_socket_option<int> settable_socket_option2;
		archetypes::settable_socket_option<double>
		    settable_socket_option3;
		archetypes::gettable_socket_option<void>
		    gettable_socket_option1;
		archetypes::gettable_socket_option<int> gettable_socket_option2;
		archetypes::gettable_socket_option<double>
		    gettable_socket_option3;
		...
		ip::tcp::socket socket4(ioc,
					ip::tcp::endpoint(ip::tcp::v4(), 0));
		ip::tcp::socket socket5(ioc,
		...
		ip::tcp::socket::lowest_layer_type &lowest_layer =
		...
		socket1.async_connect(ip::tcp::endpoint(ip::tcp::v6(), 0),
				      connect_handler());
		int i1 = socket1.async_connect(
		    ip::tcp::endpoint(ip::tcp::v4(), 0), lazy);
		(void)i1;
		int i2 = socket1.async_connect(
		    ip::tcp::endpoint(ip::tcp::v6(), 0), lazy);
		(void)i2;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		...
		socket1.async_send(buffer(mutable_char_buffer), in_flags,
				   send_handler());
		socket1.async_send(buffer(const_char_buffer), in_flags,
				   send_handler());
		...
		(void)i8;
		int i9 = socket1.async_send(buffer(mutable_char_buffer),
					    in_flags, lazy);
		(void)i9;
		int i10 = socket1.async_send(buffer(const_char_buffer),
					     in_flags, lazy);
		(void)i10;
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d4 =
		    socket1.async_send(buffer(mutable_char_buffer), dlazy);
		(void)d4;
		double d5 =
		    socket1.async_send(buffer(const_char_buffer), dlazy);
		(void)d5;
		...
		(void)d8;
		double d9 = socket1.async_send(buffer(mutable_char_buffer),
					       in_flags, dlazy);
		(void)d9;
		double d10 = socket1.async_send(buffer(const_char_buffer),
						in_flags, dlazy);
		(void)d10;
		double d11 =
		    socket1.async_send(mutable_buffers, in_flags, dlazy);
		(void)d11;
		double d12 = socket1.async_send(const_buffers, in_flags, dlazy);
		(void)d12;
		double d13 =
		    socket1.async_send(null_buffers(), in_flags, dlazy);
		(void)d13;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
		...
		socket1.async_receive(buffer(mutable_char_buffer),
				      receive_handler());
		socket1.async_receive(mutable_buffers, receive_handler());
		socket1.async_receive(null_buffers(), receive_handler());
		socket1.async_receive(buffer(mutable_char_buffer), in_flags,
				      receive_handler());
		socket1.async_receive(mutable_buffers, in_flags,
				      receive_handler());
		socket1.async_receive(null_buffers(), in_flags,
				      receive_handler());
		int i14 =
		    socket1.async_receive(buffer(mutable_char_buffer), lazy);
		(void)i14;
		int i15 = socket1.async_receive(mutable_buffers, lazy);
		(void)i15;
		int i16 = socket1.async_receive(null_buffers(), lazy);
		(void)i16;
		int i17 = socket1.async_receive(buffer(mutable_char_buffer),
						in_flags, lazy);
		(void)i17;
		int i18 =
		    socket1.async_receive(mutable_buffers, in_flags, lazy);
		(void)i18;
		int i19 = socket1.async_receive(null_buffers(), in_flags, lazy);
		(void)i19;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d14 =
		    socket1.async_receive(buffer(mutable_char_buffer), dlazy);
		(void)d14;
		double d15 = socket1.async_receive(mutable_buffers, dlazy);
		(void)d15;
		double d16 = socket1.async_receive(null_buffers(), dlazy);
		(void)d16;
		double d17 = socket1.async_receive(buffer(mutable_char_buffer),
						   in_flags, dlazy);
		(void)d17;
		double d18 =
		    socket1.async_receive(mutable_buffers, in_flags, dlazy);
		(void)d18;
		double d19 =
		    socket1.async_receive(null_buffers(), in_flags, dlazy);
		(void)d19;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
		...
		socket1.async_write_some(buffer(mutable_char_buffer),
					 write_some_handler());
		...
		int i20 =
		    socket1.async_write_some(buffer(mutable_char_buffer), lazy);
		(void)i20;
		int i21 =
		    socket1.async_write_some(buffer(const_char_buffer), lazy);
		(void)i21;
		...
		(void)i24;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d20 = socket1.async_write_some(
		    buffer(mutable_char_buffer), dlazy);
		(void)d20;
		double d21 =
		    socket1.async_write_some(buffer(const_char_buffer), dlazy);
		(void)d21;
		...
		socket1.async_read_some(buffer(mutable_char_buffer),
					read_some_handler());
		socket1.async_read_some(mutable_buffers, read_some_handler());
		socket1.async_read_some(null_buffers(), read_some_handler());
		int i25 =
		    socket1.async_read_some(buffer(mutable_char_buffer), lazy);
		(void)i25;
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d25 =
		    socket1.async_read_some(buffer(mutable_char_buffer), dlazy);
		(void)d25;
...
void test()
{
	...
	BOOST_ASIO_CHECK(memcmp(read_buffer, write_data, sizeof(write_data)) ==
			 0);
...
void test()
{
	...
	try {
		...
		ip::tcp::acceptor acceptor4(
		    ioc, ip::tcp::endpoint(ip::tcp::v4(), 0));
		ip::tcp::acceptor acceptor5(
		    ioc, ip::tcp::endpoint(ip::tcp::v6(), 0));
#if !defined(BOOST_ASIO_WINDOWS_RUNTIME)
		ip::tcp::acceptor::native_handle_type native_acceptor1 =
		    ::socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
		ip::tcp::acceptor acceptor6(ioc, ip::tcp::v4(),
					    native_acceptor1);
#endif // !defined(BOOST_ASIO_WINDOWS_RUNTIME)
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d1 =
		    acceptor1.async_wait(socket_base::wait_write, dlazy);
		(void)d1;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
		...
		acceptor1.async_accept(peer_socket, peer_endpoint,
				       accept_handler());
		int i2 = acceptor1.async_accept(peer_socket, lazy);
		(void)i2;
		int i3 =
		    acceptor1.async_accept(peer_socket, peer_endpoint, lazy);
		(void)i3;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d2 = acceptor1.async_accept(peer_socket, dlazy);
		(void)d2;
		double d3 =
		    acceptor1.async_accept(peer_socket, peer_endpoint, dlazy);
		(void)d3;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
...
void test()
{
	...
	BOOST_ASIO_CHECK(client_side_local_endpoint.port() ==
	...
	acceptor.async_accept(server_side_socket, client_endpoint,
			      &handle_accept);
	client_side_socket.async_connect(server_endpoint, &handle_connect);
...
void test()
{
	...
	try {
		...
		ip::tcp::resolver::results_type results2 =
		...
		ip::tcp::resolver::results_type results9 = resolver.resolve(
		    ip::tcp::v4(), "", "", ip::tcp::resolver::flags());
		(void)results9;

		ip::tcp::resolver::results_type results10 = resolver.resolve(
		    ip::tcp::v4(), "", "", ip::tcp::resolver::flags(), ec);
		(void)results10;

		ip::tcp::resolver::results_type results11 = resolver.resolve(e);
		(void)results11;

		ip::tcp::resolver::results_type results12 =
		    resolver.resolve(e, ec);
		(void)results12;
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d4 =
		    resolver.async_resolve(ip::tcp::v4(), "", "", dlazy);
		(void)d4;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)

		resolver.async_resolve(ip::tcp::v4(), "", "",
				       ip::tcp::resolver::flags(),
				       resolve_handler());
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		resolver.async_resolve(ip::tcp::v4(), "", "",
				       ip::tcp::resolver::flags(),
				       legacy_resolve_handler());
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
		int i5 = resolver.async_resolve(
		    ip::tcp::v4(), "", "", ip::tcp::resolver::flags(), lazy);
		(void)i5;
#if !defined(BOOST_ASIO_NO_DEPRECATED)
		double d5 = resolver.async_resolve(
		    ip::tcp::v4(), "", "", ip::tcp::resolver::flags(), dlazy);
		(void)d5;
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
...
void test()
{
	...
	try {
		...
		ip::basic_resolver_entry<ip::tcp> entry2(endpoint, host_name,
							 service_name);
...
void test()
{
	...
	basic_socket<ip::tcp, stream_socket_service<ip::tcp>> &sref =
	    ios1.socket();

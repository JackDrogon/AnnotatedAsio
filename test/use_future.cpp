...
BOOST_ASIO_TEST_SUITE(
    "use_future",
    BOOST_ASIO_TEST_CASE(use_future_0_test) BOOST_ASIO_TEST_CASE(
	use_future_1_test) BOOST_ASIO_TEST_CASE(use_future_2_test)
	BOOST_ASIO_TEST_CASE(use_future_3_test) BOOST_ASIO_TEST_CASE(
	    use_future_package_0_test)
	    BOOST_ASIO_TEST_CASE(use_future_package_1_test) BOOST_ASIO_TEST_CASE(
		use_future_package_2_test)
		BOOST_ASIO_TEST_CASE(use_future_package_3_test) BOOST_ASIO_TEST_CASE(
		    deprecated_use_future_0_test)
			...
			BOOST_ASIO_TEST_CASE(deprecated_use_future_2_test)
				...
				BOOST_ASIO_TEST_CASE(
				    deprecated_use_future_package_0_test)
				    BOOST_ASIO_TEST_CASE(
					deprecated_use_future_package_1_test)
					BOOST_ASIO_TEST_CASE(
					    deprecated_use_future_package_2_test)
					    BOOST_ASIO_TEST_CASE(
						deprecated_use_future_package_3_test))

...
struct deprecated_concrete_handler {
	...
	template <typename Arg1> void operator()(Arg1) {}

	template <typename Arg1, typename Arg2> void operator()(Arg1, Arg2) {}
...
template <> class async_result<archetypes::deprecated_concrete_handler>
{
public:

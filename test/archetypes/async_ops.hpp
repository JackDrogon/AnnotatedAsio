...
async_op_0(BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	...
	boost::asio::async_completion<CompletionToken, void()> completion(
	    token);
...
async_op_ec_0(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	...
	if (ok) {
		...
		ex.post(
		    bindns::bind(BOOST_ASIO_MOVE_CAST(handler_type)(
				     completion.completion_handler),
				 boost::system::error_code(
...
async_op_1(BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	...
	boost::asio::async_completion<CompletionToken, void(int)> completion(
	    token);
...
async_op_ex_1(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	...
	if (ok) {
		...
		ex.post(bindns::bind(
			    BOOST_ASIO_MOVE_CAST(handler_type)(
				completion.completion_handler),
...
{
	typedef typename boost::asio::async_completion<
	    CompletionToken, void(int, double)>::completion_handler_type
	    handler_type;

	boost::asio::async_completion<CompletionToken, void(int, double)>
	    completion(token);
...
async_op_ec_2(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	typedef typename boost::asio::async_completion<
	    CompletionToken, void(boost::system::error_code, int,
				  double)>::completion_handler_type
	    handler_type;
...
async_op_ec_3(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
	...
	boost::asio::async_completion<
	    CompletionToken, void(boost::system::error_code, int, double, char)>
	    completion(token);

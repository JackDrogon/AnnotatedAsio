...
public:
	...
	test_stream(boost::asio::io_context &io_context)
	    : io_context_(io_context), length_(0), position_(0),
	      next_read_length_(0)
	{
	}
...
void test_3_arg_mutable_buffer_read()
{
	...
	memset(read_buf, 0, sizeof(read_buf));
	bytes_transferred =
	    boost::asio::read(s, buffers, old_style_transfer_all);
	BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
	BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_4_arg_mutable_buffer_read()
{
	...
	memset(read_buf, 0, sizeof(read_buf));
	bytes_transferred =
	    boost::asio::read(s, buffers, short_transfer, error);
	BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
	BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
	BOOST_ASIO_CHECK(!error);
...
void test_4_arg_streambuf_read()
{
	...
	sb.consume(sb.size());
	bytes_transferred =
	    boost::asio::read(s, sb, old_style_transfer_all, error);
	BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
	BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
	BOOST_ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
	BOOST_ASIO_CHECK(!error);
...
BOOST_ASIO_TEST_SUITE(
	...
	BOOST_ASIO_TEST_CASE(test_2_arg_streambuf_read) BOOST_ASIO_TEST_CASE(
	    test_3_arg_nothrow_zero_buffers_read) BOOST_ASIO_TEST_CASE(test_3_arg_nothrow_mutable_buffer_read)
	    BOOST_ASIO_TEST_CASE(test_3_arg_nothrow_vector_buffers_read) BOOST_ASIO_TEST_CASE(
		test_3_arg_nothrow_streambuf_read)
		BOOST_ASIO_TEST_CASE(test_3_arg_mutable_buffer_read) BOOST_ASIO_TEST_CASE(
		    test_3_arg_vector_buffers_read) BOOST_ASIO_TEST_CASE(test_3_arg_streambuf_read)
		    BOOST_ASIO_TEST_CASE(test_4_arg_mutable_buffer_read) BOOST_ASIO_TEST_CASE(
			test_4_arg_vector_buffers_read)
			BOOST_ASIO_TEST_CASE(test_4_arg_streambuf_read) BOOST_ASIO_TEST_CASE(
			    test_3_arg_mutable_buffer_async_read)

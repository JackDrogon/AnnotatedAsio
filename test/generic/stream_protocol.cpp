...
void test()
{
	...
	try {
		...
		sp::socket socket4(ioc, sp(af_inet, ipproto_tcp),
				   native_socket1);
		...
		sp::socket::lowest_layer_type &lowest_layer =
...
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
		Windows::Networking::Sockets::StreamSocket ^ native_socket2 =
		    nullptr;
#else  // defined(BOOST_ASIO_WINDOWS_RUNTIME)
...
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
		Windows::Networking::Sockets::StreamSocket ^ native_socket3 =
		    nullptr;
#else  // defined(BOOST_ASIO_WINDOWS_RUNTIME)
		...
		sp::socket::native_handle_type native_socket4 =

...
server::server(const std::string &address, const std::string &port,
    ...
    : io_context_pool_(io_context_pool_size),
      ...
      acceptor_(io_context_pool_.get_io_context()), new_connection_(),
...
{
	new_connection_.reset(new connection(io_context_pool_.get_io_context(),
					     request_handler_));
...
void server::handle_stop() { io_context_pool_.stop(); }

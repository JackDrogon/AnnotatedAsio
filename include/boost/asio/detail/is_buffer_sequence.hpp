...
template <typename> char (&begin_memfn_helper(...))[2];
...
template <typename> char (&end_memfn_helper(...))[2];
...
template <typename, typename> char (&buffer_element_type_helper(...))[2];
...
struct is_buffer_sequence_class
    : integral_constant<bool, sizeof(begin_memfn_helper<T>(0)) != 1 &&
...
struct is_dynamic_buffer
    : conditional<is_class<T>::value, is_dynamic_buffer_class<T>,
		  false_type>::type {
};

...
public:
	...
	struct base_implementation_type {
		...
		base_implementation_type()
		    : socket_(nullptr), next_(0), prev_(0)
		{
		}
	...
	// Constructor.
	BOOST_ASIO_DECL
	winrt_ssocket_service_base(boost::asio::io_context &io_context);
	...
	BOOST_ASIO_DECL native_handle_type
	release(base_implementation_type &impl, boost::system::error_code &ec);
	...
	boost::system::error_code non_blocking(base_implementation_type &, bool,
					       boost::system::error_code &ec)
	{
		ec = boost::asio::error::operation_not_supported;
		return ec;
	...
	native_non_blocking(base_implementation_type &, bool,
			    boost::system::error_code &ec)
	{
		ec = boost::asio::error::operation_not_supported;
		return ec;
			...
			socket_base::message_flags flags, Handler &handler)
	{
		...
		BOOST_ASIO_HANDLER_CREATION((io_context_.context(), *p.p,
					     "socket", &impl, 0, "async_send"));
...
protected:
	...
	do_get_endpoint(const base_implementation_type &impl, bool local,
	...
	BOOST_ASIO_DECL void do_get_option(const base_implementation_type &impl,
	...
	BOOST_ASIO_DECL boost::system::error_code
	do_connect(base_implementation_type &impl, const void *addr,
		   boost::system::error_code &ec);
	...
	BOOST_ASIO_DECL std::size_t
	do_send(base_implementation_type &impl,
	...
	BOOST_ASIO_DECL void
	start_send_op(base_implementation_type &impl,
		      const boost::asio::const_buffer &data,
		      socket_base::message_flags flags,

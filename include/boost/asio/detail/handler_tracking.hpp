...
public:
	...
	creation(execution_context &context, tracked_handler &h,
	...
	public:
		...
		invocation_begin(const boost::system::error_code &ec);
	...
	// Record a reactor-based operation that is associated with a handler.
	BOOST_ASIO_DECL static void
	reactor_operation(const tracked_handler &h, const char *op_name,
...
#define BOOST_ASIO_HANDLER_COMPLETION(args)                                    \
	boost::asio::detail::handler_tracking::completion tracked_completion   \
	    args

...
public:
	...
	static status do_perform(reactor_op *base)
	{
		...
		BOOST_ASIO_HANDLER_REACTOR_OPERATION(
		    (*o, "non_blocking_accept", o->ec_));
...
public:
	...
	reactive_socket_move_accept_op(
	    io_context &ioc, socket_type socket, socket_ops::state_type state,
	    const Protocol &protocol,
	    typename Protocol::endpoint *peer_endpoint, Handler &handler)
	    : Protocol::socket(ioc),
	      reactive_socket_accept_op_base<typename Protocol::socket,
					     Protocol>(
				...
				std::size_t /*bytes_transferred*/)
	{
		...
		detail::move_binder2<Handler, boost::system::error_code,
		    ...
		    handler(
			0, BOOST_ASIO_MOVE_CAST(Handler)(o->handler_), o->ec_,

    ...
    boost::system::error_code &ec)
{
	if (is_open(impl)) {
		BOOST_ASIO_HANDLER_OPERATION(
		    (iocp_service_.context(), "handle", &impl,
		     reinterpret_cast<uintmax_t>(impl.handle_), "close"));
    ...
    boost::system::error_code &ec)
{
	...
	BOOST_ASIO_HANDLER_OPERATION((iocp_service_.context(), "handle", &impl,
    ...
    const boost::asio::const_buffer &buffer, boost::system::error_code &ec)
{
	...
	ok = ::GetOverlappedResult(impl.handle_, &overlapped,

    ...
    reactive_descriptor_service::implementation_type &other_impl)
{
	...
	other_service.reactor_.move_descriptor(
	    impl.descriptor_, impl.reactor_data_, other_impl.reactor_data_);
}
...
{
	if (is_open(impl)) {
		BOOST_ASIO_HANDLER_OPERATION((reactor_.context(), "descriptor",
		...
		descriptor_ops::close(impl.descriptor_, impl.state_,
				      ignored_ec);
    ...
    reactive_descriptor_service::implementation_type &impl)
{
	...
	if (is_open(impl)) {
		...
		reactor_.deregister_descriptor(impl.descriptor_,
					       impl.reactor_data_, false);
		reactor_.cleanup_descriptor_data(impl.reactor_data_);
		construct(impl);
	}
    ...
    boost::system::error_code &ec)
{
	...
	BOOST_ASIO_HANDLER_OPERATION((reactor_.context(), "descriptor", &impl,

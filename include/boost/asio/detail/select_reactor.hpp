...
#include <boost/asio/detail/config.hpp>
    ...
    (!defined(BOOST_ASIO_HAS_DEV_POLL) && !defined(BOOST_ASIO_HAS_EPOLL) &&    \
     !defined(BOOST_ASIO_HAS_KQUEUE) && !defined(BOOST_ASIO_WINDOWS_RUNTIME))
...
public:
	...
	// code on failure.
	BOOST_ASIO_DECL int register_descriptor(socket_type,
						per_descriptor_data &);
...
private:
	...
	BOOST_ASIO_DECL void
	cancel_ops_unlocked(socket_type descriptor,

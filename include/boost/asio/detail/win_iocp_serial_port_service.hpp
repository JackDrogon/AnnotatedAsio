...
public:
	...
	typedef win_iocp_handle_service::implementation_type
	    implementation_type;

	// Constructor.
	BOOST_ASIO_DECL
	win_iocp_serial_port_service(boost::asio::io_context &io_context);
...
private:
	...
	store_option(const void *option, ::DCB &storage,
		     boost::system::error_code &ec)
	{
	...
	template <typename GettableSerialPortOption>
	static boost::system::error_code
	load_option(void *option, const ::DCB &storage,
		    boost::system::error_code &ec)
	{

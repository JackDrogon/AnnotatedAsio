...
public:
	...
	public:
		// Default constructor.
		registration()
		    : signal_number_(0), queue_(0), undelivered_(0),
		      next_in_table_(0), prev_in_table_(0), next_in_set_(0)
		{
		}
	...
	notify_fork(boost::asio::io_context::fork_event fork_ev);
	...
	add(implementation_type &impl, int signal_number,
	    boost::system::error_code &ec);

	// Remove a signal to a signal_set.
	BOOST_ASIO_DECL boost::system::error_code
	remove(implementation_type &impl, int signal_number,
	       boost::system::error_code &ec);

	// Remove all signals from a signal_set.
	BOOST_ASIO_DECL boost::system::error_code
	clear(implementation_type &impl, boost::system::error_code &ec);

...
public:
	...
	// Constructor.
	BOOST_ASIO_DECL
	resolver_service_base(boost::asio::io_context &io_context);
...
protected:
	...
	public:
		...
		operator boost::asio::detail::addrinfo_type *() { return ai_; }
...
private:
	...
	boost::asio::detail::scoped_ptr<boost::asio::io_context>
	    work_io_context_;
	...
	boost::asio::detail::scoped_ptr<boost::asio::detail::thread>
	    work_thread_;
};

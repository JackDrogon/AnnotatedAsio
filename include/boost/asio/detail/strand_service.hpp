...
class strand_service : public boost::asio::detail::service_base<strand_service>
{
private:
...
public:
	...
	BOOST_ASIO_DECL explicit strand_service(
...
private:
	...
	BOOST_ASIO_DECL bool do_dispatch(implementation_type &impl,
					 operation *op);

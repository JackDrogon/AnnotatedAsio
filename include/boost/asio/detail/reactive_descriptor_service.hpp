...
public:
	...
	// Constructor.
	BOOST_ASIO_DECL
	reactive_descriptor_service(boost::asio::io_context &io_context);
	...
	move_assign(implementation_type &impl,
					     ...
					     boost::system::error_code &ec)
	{
		descriptor_ops::ioctl(
		    impl.descriptor_, impl.state_, command.name(),
	...
	{
		return (impl.state_ & descriptor_ops::user_set_non_blocking) !=
		       0;
	}
	...
	boost::system::error_code non_blocking(implementation_type &impl,
					       ...
					       boost::system::error_code &ec)
	{
		descriptor_ops::set_user_non_blocking(impl.descriptor_,
						      impl.state_, mode, ec);
		return ec;
	}
	...
	{
		return (impl.state_ & descriptor_ops::internal_non_blocking) !=
		       0;
	}

	// Sets the non-blocking mode of the native descriptor implementation.
	boost::system::error_code
	native_non_blocking(implementation_type &impl, bool mode,
			    boost::system::error_code &ec)
	{
				       ...
				       boost::system::error_code &ec)
	{
		...
		case posix::descriptor_base::wait_read:
			descriptor_ops::poll_read(impl.descriptor_, impl.state_,
						  ec);
			break;
		case posix::descriptor_base::wait_write:
			descriptor_ops::poll_write(impl.descriptor_,
						   impl.state_, ec);
			break;
		case posix::descriptor_base::wait_error:
			descriptor_ops::poll_error(impl.descriptor_,
						   impl.state_, ec);
			break;
		default:
			...
			posix::descriptor_base::wait_type w, Handler &handler)
	{
		...
		BOOST_ASIO_HANDLER_CREATION((reactor_.context(), *p.p,
					     "descriptor", &impl,
			      ...
			      Handler &handler)
	{
		...
		BOOST_ASIO_HANDLER_CREATION(
		    (reactor_.context(), *p.p, "descriptor", &impl,
			     ...
			     Handler &handler)
	{
		...
		start_op(impl, reactor::read_op, p.p, is_continuation, false,
			 false);
		p.v = p.p = 0;
	}

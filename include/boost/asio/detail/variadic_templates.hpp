...
#define BOOST_ASIO_VARIADIC_TPARAMS_1 typename T1
#define BOOST_ASIO_VARIADIC_TPARAMS_2 typename T1, typename T2
#define BOOST_ASIO_VARIADIC_TPARAMS_3 typename T1, typename T2, typename T3
...
#define BOOST_ASIO_VARIADIC_BYVAL_PARAMS(n) BOOST_ASIO_VARIADIC_BYVAL_PARAMS_##n
...
#define BOOST_ASIO_VARIADIC_BYVAL_ARGS(n) BOOST_ASIO_VARIADIC_BYVAL_ARGS_##n
...
#define BOOST_ASIO_VARIADIC_MOVE_PARAMS(n) BOOST_ASIO_VARIADIC_MOVE_PARAMS_##n

#define BOOST_ASIO_VARIADIC_MOVE_PARAMS_1 BOOST_ASIO_MOVE_ARG(T1) x1
...
#define BOOST_ASIO_VARIADIC_MOVE_PARAMS_3                                      \
	...
	x1, BOOST_ASIO_MOVE_ARG(T2) x2, BOOST_ASIO_MOVE_ARG(T3) x3
#define BOOST_ASIO_VARIADIC_MOVE_PARAMS_4                                      \
	BOOST_ASIO_MOVE_ARG(T1)                                                \
	x1, BOOST_ASIO_MOVE_ARG(T2) x2, BOOST_ASIO_MOVE_ARG(T3) x3,            \
	    BOOST_ASIO_MOVE_ARG(T4) x4
#define BOOST_ASIO_VARIADIC_MOVE_PARAMS_5                                      \
	BOOST_ASIO_MOVE_ARG(T1)                                                \
	x1, BOOST_ASIO_MOVE_ARG(T2) x2, BOOST_ASIO_MOVE_ARG(T3) x3,            \
	    BOOST_ASIO_MOVE_ARG(T4) x4, BOOST_ASIO_MOVE_ARG(T5) x5

#define BOOST_ASIO_VARIADIC_MOVE_ARGS(n) BOOST_ASIO_VARIADIC_MOVE_ARGS_##n

#define BOOST_ASIO_VARIADIC_MOVE_ARGS_1 BOOST_ASIO_MOVE_CAST(T1)(x1)
...
#define BOOST_ASIO_VARIADIC_MOVE_ARGS_3                                        \
	BOOST_ASIO_MOVE_CAST(T1)                                               \
	(x1), BOOST_ASIO_MOVE_CAST(T2)(x2), BOOST_ASIO_MOVE_CAST(T3)(x3)
#define BOOST_ASIO_VARIADIC_MOVE_ARGS_4                                        \
	BOOST_ASIO_MOVE_CAST(T1)                                               \
	(x1), BOOST_ASIO_MOVE_CAST(T2)(x2), BOOST_ASIO_MOVE_CAST(T3)(x3),      \
	    BOOST_ASIO_MOVE_CAST(T4)(x4)
#define BOOST_ASIO_VARIADIC_MOVE_ARGS_5                                        \
	BOOST_ASIO_MOVE_CAST(T1)                                               \
	(x1), BOOST_ASIO_MOVE_CAST(T2)(x2), BOOST_ASIO_MOVE_CAST(T3)(x3),      \
	    BOOST_ASIO_MOVE_CAST(T4)(x4), BOOST_ASIO_MOVE_CAST(T5)(x5)

#define BOOST_ASIO_VARIADIC_DECAY(n) BOOST_ASIO_VARIADIC_DECAY_##n

#define BOOST_ASIO_VARIADIC_DECAY_1 typename decay<T1>::type

...
public:
	...
	post_deferred_completions(op_queue<operation> &ops);
...
private:
	...
	do_run_one(mutex::scoped_lock &lock, thread_info &this_thread,
	...
	BOOST_ASIO_DECL void
	wake_one_thread_and_unlock(mutex::scoped_lock &lock);

...
bool address_v4::is_unspecified() const { return to_uint() == 0; }
...
address_v4 make_address_v4(const char *str, boost::system::error_code &ec)
{
...
address_v4 make_address_v4(string_view str, boost::system::error_code &ec)
{

...
public:
	/// Default constructor.
	network_v4() BOOST_ASIO_NOEXCEPT : address_(), prefix_length_(0) {}
	...
	address_v4 address() const BOOST_ASIO_NOEXCEPT { return address_; }
	...
	/// Get the network as an address in dotted decimal format.
	BOOST_ASIO_DECL std::string
	to_string(boost::system::error_code &ec) const;

	/// Compare two networks for equality.
	friend bool operator==(const network_v4 &a, const network_v4 &b)
	{
		return a.address_ == b.address_ &&
		       a.prefix_length_ == b.prefix_length_;
	}

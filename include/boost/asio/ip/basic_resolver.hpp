...
public:
   ...
   */
	...
	{
		return this->get_service().resolve(this->get_implementation(),
						   q, ec);
	}
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   */
		      ...
		      BOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
	{
		...
		BOOST_ASIO_RESOLVE_HANDLER_CHECK(ResolveHandler, handler,
						 results_type)
		type_check;
   ...
   */
		      ...
		      BOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
	{
		return async_resolve(
		    host, service, resolver_base::flags(),
		    BOOST_ASIO_MOVE_CAST(ResolveHandler)(handler));
	}
   ...
   */
	...
	{
		return async_resolve(
		    protocol, host, service, resolver_base::flags(),
		    BOOST_ASIO_MOVE_CAST(ResolveHandler)(handler));
	}

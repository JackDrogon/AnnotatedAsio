...
struct associated_executor_impl {
	...
	static type get(const T &, const E &e) BOOST_ASIO_NOEXCEPT { return e; }
};
...
struct associated_executor {
	...
	typedef
	    typename detail::associated_executor_impl<T, Executor>::type type;
	...
	{
		return detail::associated_executor_impl<T, Executor>::get(t,
									  ex);
	}
};
...
inline
	...
	typename enable_if<is_convertible<ExecutionContext &,
	    ...
	    0) BOOST_ASIO_NOEXCEPT
{
	return associated_executor<
	    T,
	    typename ExecutionContext::executor_type>::get(t,
							   ctx.get_executor());
}

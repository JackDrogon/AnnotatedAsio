...
public:
	...
	BOOST_ASIO_DECL virtual const char *
	what() const BOOST_ASIO_NOEXCEPT_OR_NOTHROW;
};
...
public:
	/// Default constructor.
	executor() BOOST_ASIO_NOEXCEPT : impl_(0) {}

	/// Construct from nullptr.
	executor(nullptr_t) BOOST_ASIO_NOEXCEPT : impl_(0) {}
	...
	/// Move constructor.
	executor(executor &&other) BOOST_ASIO_NOEXCEPT : impl_(other.impl_)
	{
		other.impl_ = 0;
	}
   ...
   */
	template <typename Executor> Executor *target() BOOST_ASIO_NOEXCEPT;
...
private:
	...
	public:
		...
		virtual type_id_result_type
		target_type() const BOOST_ASIO_NOEXCEPT = 0;
		virtual void *target() BOOST_ASIO_NOEXCEPT = 0;
		virtual const void *target() const BOOST_ASIO_NOEXCEPT = 0;
		virtual bool
		equals(const impl_base *e) const BOOST_ASIO_NOEXCEPT = 0;

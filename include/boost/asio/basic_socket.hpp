...
public:
   ...
   */
	...
	__declspec(deprecated("By default, this function always fails with "
			      "operation_not_supported when used on Windows "
   ...
   */
	bool at_mark() const
	{
		boost::system::error_code ec;
		bool b =
		    this->get_service().at_mark(this->get_implementation(), ec);
   ...
   */
	...
	{
		return this->get_service().at_mark(this->get_implementation(),
						   ec);
	}
   ...
   */
	...
	{
		return this->get_service().available(this->get_implementation(),
						     ec);
	}
   ...
   */
	void connect(const endpoint_type &peer_endpoint)
	{
		...
		this->get_service().connect(this->get_implementation(),
					    peer_endpoint, ec);
		boost::asio::detail::throw_error(ec, "connect");
	}
   ...
   */
	...
	{
		return this->get_service().remote_endpoint(
		    this->get_implementation(), ec);
	}
   ...
   */
	...
	{
		boost::system::error_code ec;
		this->get_service().shutdown(this->get_implementation(), what,
					     ec);

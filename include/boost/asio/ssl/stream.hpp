...
public:
   ...
   * @note Calls @c SSL_set_verify.
   */
	BOOST_ASIO_SYNC_OP_VOID set_verify_mode(verify_mode v,
						boost::system::error_code &ec)
	{
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
	BOOST_ASIO_SYNC_OP_VOID set_verify_depth(int depth,
						 boost::system::error_code &ec)
	{
   ...
   */
					  ...
					  boost::system::error_code &ec)
	{
		detail::io(next_layer_, core_,
			   detail::buffered_handshake_op<ConstBufferSequence>(
			       type, buffers),
			   ec);
		BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
	}
   ...
   */
			...
			BOOST_ASIO_MOVE_ARG(BufferedHandshakeHandler) handler)
	{
		...
		detail::async_io(
		    next_layer_, core_,
		    detail::buffered_handshake_op<ConstBufferSequence>(type,
								       buffers),
		    init.completion_handler);

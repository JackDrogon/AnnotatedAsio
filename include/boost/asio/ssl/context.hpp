...
public:
   ...
   */
	BOOST_ASIO_DECL void use_certificate(const const_buffer &certificate,
					     file_format format);
   ...
   */
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	use_certificate(const const_buffer &certificate, file_format format,
			boost::system::error_code &ec);
   ...
   */
	BOOST_ASIO_DECL void use_certificate_file(const std::string &filename,
						  file_format format);
   ...
   */
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	use_certificate_file(const std::string &filename, file_format format,
			     boost::system::error_code &ec);
   ...
   */
	...
	use_certificate_chain_file(const std::string &filename);
   ...
   */
	BOOST_ASIO_DECL void use_private_key(const const_buffer &private_key,
					     file_format format);
   ...
   */
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	use_private_key(const const_buffer &private_key, file_format format,
			boost::system::error_code &ec);
   ...
   */
	BOOST_ASIO_DECL void use_private_key_file(const std::string &filename,
						  file_format format);
   ...
   */
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	use_private_key_file(const std::string &filename, file_format format,
			     boost::system::error_code &ec);
...
private:
	...
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	do_set_verify_callback(detail::verify_callback_base *callback,
			       boost::system::error_code &ec);

	// Callback used when the SSL implementation wants to verify a certificate.
	BOOST_ASIO_DECL static int
	verify_callback_function(int preverified, X509_STORE_CTX *ctx);

	// Helper function used to set a password callback.
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	do_set_password_callback(detail::password_callback_base *callback,
				 boost::system::error_code &ec);

	// Callback used when the SSL implementation wants a password.
	BOOST_ASIO_DECL static int password_callback_function(char *buf,
							      int size,
							      int purpose,
							      void *data);
	...
	BOOST_ASIO_DECL BOOST_ASIO_SYNC_OP_VOID
	do_use_tmp_dh(BIO *bio, boost::system::error_code &ec);

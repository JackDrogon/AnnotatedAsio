...
public:
    ...
    (OPENSSL_VERSION_NUMBER < 0x10100000L) && !defined(SSL_OP_NO_COMPRESSION)
...
private:
...
#if (OPENSSL_VERSION_NUMBER < 0x10100000L)
	static void openssl_locking_func(int mode, int n, const char * /*file*/,
					 int /*line*/)
	{
		if (mode & CRYPTO_LOCK)
	...
	std::vector<boost::asio::detail::shared_ptr<boost::asio::detail::mutex>>
	    mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)

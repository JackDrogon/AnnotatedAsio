...
public:
	...
	typedef
	    typename async_result<completion_handler_type>::type return_type;
#endif // defined(BOOST_ASIO_NO_DEPRECATED) || defined(GENERATING_DOCUMENTATION)
 ...
 */
template <typename Handler> class async_result<Handler>
{
public:
	/// The return type of the initiating function.
	typedef void type;
	...
	explicit async_completion(CompletionToken &token)
	    : completion_handler(
		  static_cast<typename conditional<
		      ...
		      completion_handler_type &, CompletionToken &&>::type>(
		      token)),
...
#define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) void_or_deduced
#elif defined(_MSC_VER) && (_MSC_VER < 1500)
#define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig)                                 \
	typename ::boost::asio::detail::async_result_helper<ct,                \
							    sig>::return_type

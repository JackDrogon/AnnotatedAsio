...
protected:
	...
	basic_socket_streambuf<Protocol BOOST_ASIO_SVC_TARG, Clock,
			       WaitTraits BOOST_ASIO_SVC_TARG1>
	    streambuf_;
};
...
class basic_socket_iostream
    : private detail::socket_iostream_base<Protocol BOOST_ASIO_SVC_TARG, Clock,
					   WaitTraits BOOST_ASIO_SVC_TARG1>,
...
public:
	...
	explicit basic_socket_iostream(basic_stream_socket<protocol_type> s)
	    : detail::socket_iostream_base<Protocol BOOST_ASIO_SVC_TARG, Clock,
					   WaitTraits BOOST_ASIO_SVC_TARG1>(
		  std::move(s)),
	      std::basic_iostream<char>(
		  &this->detail::socket_iostream_base<
	...
	basic_socket_iostream &operator=(basic_socket_iostream &&other)
	{
		...
		detail::socket_iostream_base<Protocol BOOST_ASIO_SVC_TARG,
					     Clock,
					     WaitTraits BOOST_ASIO_SVC_TARG1>::
...
private:
	...
	basic_socket_iostream &
	operator=(const basic_socket_iostream &) BOOST_ASIO_DELETED;
};

...
template <typename Clock, typename WaitTraits> class waitable_timer_service;

#if defined(BOOST_ASIO_HAS_BOOST_DATE_TIME)

template <typename TimeType, typename TimeTraits> class deadline_timer_service;
...
template <class Protocol BOOST_ASIO_SVC_TPARAM> class basic_socket;

template <typename Protocol BOOST_ASIO_SVC_TPARAM> class basic_datagram_socket;

template <typename Protocol BOOST_ASIO_SVC_TPARAM> class basic_stream_socket;

template <typename Protocol BOOST_ASIO_SVC_TPARAM> class basic_socket_acceptor;
...
template <typename InternetProtocol BOOST_ASIO_SVC_TPARAM> class basic_resolver;

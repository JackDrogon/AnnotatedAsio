...
dispatch(BOOST_ASIO_MOVE_ARG(CompletionToken) token);
...
BOOST_ASIO_INITFN_RESULT_TYPE(CompletionToken, void())
dispatch(const Executor &ex, BOOST_ASIO_MOVE_ARG(CompletionToken) token,
...
BOOST_ASIO_INITFN_RESULT_TYPE(CompletionToken, void())
dispatch(ExecutionContext &ctx, BOOST_ASIO_MOVE_ARG(CompletionToken) token,

...
public:
...
#else
	typedef
	    typename service_impl_type::native_handle_type native_handle_type;
#endif
	...
	explicit raw_socket_service(boost::asio::io_context &io_context)
	    : boost::asio::detail::service_base<raw_socket_service<Protocol>>(
		  io_context),
	...
	void move_assign(implementation_type &impl,
			 ...
			 implementation_type &other_impl)
	{
		service_impl_.move_assign(impl, other_service.service_impl_,
					  other_impl);
	}
	...
	void converting_move_construct(
	    ...
	    typename raw_socket_service<Protocol1>::implementation_type
		&other_impl,
	...
	std::size_t
	send(implementation_type &impl, const ConstBufferSequence &buffers,
	...
	std::size_t
	receive(implementation_type &impl, const MutableBufferSequence &buffers,
		socket_base::message_flags flags, boost::system::error_code &ec)
	{
	...
	std::size_t receive_from(implementation_type &impl,
				 ...
				 boost::system::error_code &ec)
	{
		return service_impl_.receive_from(impl, buffers,
			   ...
			   BOOST_ASIO_MOVE_ARG(ReadHandler) handler)
	{
		...
		service_impl_.async_receive_from(impl, buffers, sender_endpoint,
						 flags,
						 init.completion_handler);
